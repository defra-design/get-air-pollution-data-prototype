...
// Set dimensions and margins for the chart
  function drawChart() {
    ...
    d3.select("#chart-container-month").selectAll("*").remove();
  
    // Set dimensions and margins for the chart
    const margin = { top: 20, right: 10, bottom: 50, left: 40 };
    
    // Use the full width of the container
    const width = document.getElementById("chart-container-month").clientWidth - margin.left - margin.right; // Use container's width
...
const svg = d3.select("#chart-container-month")
  .append("svg")
...
//Load data
  d3.csv("/public/javascripts/version_7/chart-data/past-month/no2.csv").then(function (data) {
...
// Create event listeners for the chart-container-month to show/hide elements
d3.select("#chart-container-month")
