...
// Set dimensions and margins for the chart
  function drawChart() {
    ...
    d3.select("#ozone-container").selectAll("*").remove();
  
    // Set dimensions and margins for the chart
    const margin = { top: 20, right: 10, bottom: 40, left: 40 };
    
    // Use the full width of the container
    const width = document.getElementById("ozone-container").clientWidth - margin.left - margin.right; // Use container's width
...
const svg = d3.select("#ozone-container")
  .append("svg")
...
d3.csv("/public/javascripts/version_7/chart-data/ozone-dc.csv").then(function (data) {
...
.attr("y", y(120000) - 65) // Position it slightly above the line
