...
// Set dimensions and margins for the chart
  function drawChart() {
    ...
    d3.select("#chart-container-24").selectAll("*").remove();
  
    // Set dimensions and margins for the chart
    const margin = { top: 20, right: 10, bottom: 50, left: 40 };
    
    // Use the full width of the container
    const width = document.getElementById("chart-container-24").clientWidth - margin.left - margin.right; // Use container's width
...
const svg = d3.select("#chart-container-24")
  .append("svg")
...
// Load and process the data
  d3.csv("/public/javascripts/version_7/chart-data/24hour/no2.csv").then(function (data) {
...
// Create event listeners for the chart-container-24 to show/hide elements
d3.select("#chart-container-24")
