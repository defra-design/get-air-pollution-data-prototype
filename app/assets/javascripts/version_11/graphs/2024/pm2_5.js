...
// Set dimensions and margins for the chart
  function drawChart() {
    ...
    d3.select("#pm2_5-container-2024").selectAll("*").remove();
  
    // Set dimensions and margins for the chart
    const margin = { top: 20, right: 10, bottom: 40, left: 40 };
    
    // Use the full width of the container
    const width = document.getElementById("pm2_5-container-2024").clientWidth - margin.left - margin.right; // Use container's width
...
const svg = d3.select("#pm2_5-container-2024")
  .append("svg")
...
d3.csv("/public/javascripts/version_7/chart-data/2024/pm2_5.csv").then(function (data) {
...
svg.append("line")
  ...
  // Add the y-axis
    ...
    .style("font-size", "16px")
    .call(d3.axisLeft(y)
    .ticks(2) // Adjust the number of ticks as needed
...
labelGroup.append("foreignObject")
  ...
  .attr("y", y(50) - 65) // Position it slightly above the line
...
// Create event listeners for the pm2_5-container-2024 to show/hide elements
d3.select("#pm2_5-container-2024")
