...
// Set dimensions and margins for the chart
  function drawChart() {
    ...
    d3.select("#pm2_5-container-week").selectAll("*").remove();
  
    // Set dimensions and margins for the chart
    const margin = { top: 20, right: 10, bottom: 50, left: 40 };
    
    // Use the full width of the container
    const width = document.getElementById("pm2_5-container-week").clientWidth - margin.left - margin.right; // Use container's width
...
const svg = d3.select("#pm2_5-container-week")
  .append("svg")
...
//Load data
  d3.csv("/public/javascripts/version_7/chart-data/past-week/pm2_5.csv").then(function (data) {
...
// Create event listeners for the pm2_5-container-week to show/hide elements
d3.select("#pm2_5-container-week")
