...
// Set dimensions and margins for the chart
  function drawChart() {
    ...
    d3.select("#pm2_5-container").selectAll("*").remove();
  
    // Set dimensions and margins for the chart
    const margin = { top: 20, right: 10, bottom: 40, left: 40 };
    
    // Use the full width of the container
    const width = document.getElementById("pm2_5-container").clientWidth - margin.left - margin.right; // Use container's width
...
const svg = d3.select("#pm2_5-container")
  .append("svg")
...
d3.csv("/public/javascripts/version_7/chart-data/pm2_5.csv").then(function (data) {
...
labelGroup.append("foreignObject")
  ...
  .attr("y", y(50000) - 25) // Position it slightly above the line
